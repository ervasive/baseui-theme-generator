...
import { type PaletteT, type ThemeConfigT, type ColorsT } from "./types";
...
export function generateColors(
  ...
  try {
    ...
    const setColor = (light: string, dark: ?string): string => {
      ...
      if (paletteColors.hasOwnProperty(color)) {
...
export default function generateTheme(
  ...
  const theme = {
    ...
    colors: generateColors(palette, type),
    typography: {
      font100: {
